...
using InsightLogger.Infrastructure.Knowledge;
...
public static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<IKnowledgeReferenceSource, OfficialDocumentationKnowledgeReferenceSource>();
        services.AddScoped<IKnowledgeReferenceSource, InternalKnowledgeReferenceSource>();
        services.AddScoped<IKnowledgeReferenceService, KnowledgeReferenceService>();
