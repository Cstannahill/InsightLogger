...
public sealed class AnalyzeBuildLogRequestValidator : IApiRequestValidator<AnalyzeBuildLogRequest>
{
    public void ValidateAndThrow(AnalyzeBuildLogRequest request)
    {
